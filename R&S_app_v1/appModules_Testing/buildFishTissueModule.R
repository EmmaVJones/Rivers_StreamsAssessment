...
# Bring in Fish Tissue data
fishPCB <- read_excel('exampleData/fishTissue/2017_fish_PCBs.xlsx')
fishMetals <- read_excel('exampleData/fishTissue/2017_fish_Metals.xlsx')

# Function to compare input value against a limit
limitExceedance <- function(x, parameter, limit){
